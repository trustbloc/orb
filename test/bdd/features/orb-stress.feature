...
Feature: Using Orb stress test
  ...
  Scenario:
    ...
    Given orb-cli is executed with args 'acceptlist add --url https://localhost:48326/services/orb/acceptlist --actor did:web:orb.domain2.com:services:orb --type follow --tls-cacerts fixtures/keys/tls/ec-cacert.pem --auth-token ADMIN_TOKEN'
