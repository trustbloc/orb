...
Feature:
  ...
  Scenario: Get ActivityPub service
    When an HTTP GET is sent to "http://orb.domain1.com/services/orb"
    ...
    When an HTTP GET is sent to "http://orb.domain2.com/services/orb"
    Then the JSON path "type" of the response equals "Service"
  ...
  Scenario: Get service public key
    When an HTTP GET is sent to "http://orb.domain1.com/services/orb/keys/main-key"
    Then the JSON path "id" of the response equals "http://orb.domain1.com/services/orb/keys/main-key"
    Then the JSON path "owner" of the response equals "http://orb.domain1.com/services/orb"
    Then the JSON path "publicKeyPem" of the response is not empty

    When an HTTP GET is sent to "http://orb.domain2.com/services/orb/keys/main-key"
    Then the JSON path "id" of the response equals "http://orb.domain2.com/services/orb/keys/main-key"
    Then the JSON path "owner" of the response equals "http://orb.domain2.com/services/orb"
    Then the JSON path "publicKeyPem" of the response is not empty
  ...
  Scenario: follow/accept/undo
    ...
    When an HTTP GET is sent to "http://orb.domain1.com/services/orb/inbox"
    ...
    When an HTTP GET is sent to "http://orb.domain1.com/services/orb/inbox?page=true"
    ...
    When an HTTP GET is sent to "http://orb.domain1.com/services/orb/followers"
    ...
    When an HTTP GET is sent to "http://orb.domain1.com/services/orb/followers?page=true"
    Then the JSON path "type" of the response equals "CollectionPage"
    And the JSON path "items" of the response contains "${domain2IRI}"

    When an HTTP GET is sent to "http://orb.domain2.com/services/orb/following"
    Then the JSON path "type" of the response equals "Collection"
    ...
    When an HTTP GET is sent to "http://orb.domain2.com/services/orb/following?page=true"
    Then the JSON path "type" of the response equals "CollectionPage"
    ...
    When an HTTP POST is sent to "http://orb.domain2.com/services/orb/outbox" with content "${undoFollowActivity}" of type "application/json"
  ...
  Scenario: create/announce
    ...
    When an HTTP POST is sent to "http://orb.domain2.com/services/orb/outbox" with content "${followDomain1Activity}" of type "application/json"
    ...
    When an HTTP POST is sent to "http://orb.domain3.com/services/orb/outbox" with content "${followDomain2Activity}" of type "application/json"
    Then the value of the JSON string response is saved to variable "follow2ID"

    Then we wait 2 seconds

    When an HTTP GET is sent to "http://orb.domain2.com/services/orb/followers?page=true"
    Then the JSON path "type" of the response equals "CollectionPage"
    And the JSON path "items" of the response contains "${domain3IRI}"

    # Post 'Create' activity to domain1's outbox
    When an HTTP POST is sent to "http://orb.domain1.com/services/orb/outbox" with content from file "./fixtures/testdata/create_activity.json"

    Then we wait 2 seconds

    # A 'Create' activity should have been posted to domain1's followers (domain2).
    When an HTTP GET is sent to "http://orb.domain2.com/services/orb/inbox?page=true"
    Then the JSON path "type" of the response equals "OrderedCollectionPage"
    ...
    When an HTTP GET is sent to "http://orb.domain2.com/services/orb/outbox?page=true"
    Then the JSON path "type" of the response equals "OrderedCollectionPage"
    ...
    When an HTTP GET is sent to "http://orb.domain3.com/services/orb/inbox?page=true"
    Then the JSON path "type" of the response equals "OrderedCollectionPage"
    And the JSON path "orderedItems.#.type" of the response contains "Announce"
    ...
    When an HTTP POST is sent to "http://orb.domain2.com/services/orb/outbox" with content "${undoFollow1Activity}" of type "application/json"
    ...
    When an HTTP POST is sent to "http://orb.domain3.com/services/orb/outbox" with content "${undoFollow2Activity}" of type "application/json"
    ...
    When an HTTP GET is sent to "http://orb.domain3.com/services/orb/shares?id=http%3A%2F%2Forb.domain1.com%2Ftransactions%2Fbafkreiduenhjrl7hjgh3lwxr6nvmfv4kzqzzizhzkbydxdabtcjptavzbm"
    Then the JSON path "type" of the response equals "OrderedCollection"
    Then the JSON path "first" of the response is saved to variable "sharesFirstPage"
    When an HTTP GET is sent to "${sharesFirstPage}"
    Then the JSON path "type" of the response equals "OrderedCollectionPage"
    And the JSON path "orderedItems.0.object.items.0.id" of the response equals "http://orb.domain1.com/transactions/bafkreiduenhjrl7hjgh3lwxr6nvmfv4kzqzzizhzkbydxdabtcjptavzbm"
  ...
  Scenario: invite witness/accept/undo
    ...
    And variable "inviteWitnessActivity" is assigned the JSON value '{"@context":["https://www.w3.org/ns/activitystreams","http://trustbloc.github.io/did-method-orb/contexts/anchor/v1"],"type":"InviteWitness","actor":"${domain1IRI}","to":"${domain2IRI}","object":"${domain2IRI}"}'
    ...
    When an HTTP GET is sent to "http://orb.domain1.com/services/orb/witnesses"
    Then the JSON path "type" of the response equals "Collection"
    ...
    When an HTTP GET is sent to "http://orb.domain1.com/services/orb/witnesses?page=true"
    Then the JSON path "type" of the response equals "CollectionPage"
    And the JSON path "items" of the response contains "${domain2IRI}"

    When an HTTP GET is sent to "http://orb.domain2.com/services/orb/witnessing"
    Then the JSON path "type" of the response equals "Collection"
    ...
    When an HTTP GET is sent to "http://orb.domain2.com/services/orb/witnessing?page=true"
    Then the JSON path "type" of the response equals "CollectionPage"
    And the JSON path "items" of the response contains "${domain1IRI}"
    ...
    When an HTTP POST is sent to "http://orb.domain1.com/services/orb/outbox" with content "${undoInviteWitnessActivity}" of type "application/json"
  ...
  Scenario: offer/like
    ...
    Given variable "inviteWitnessActivity" is assigned the JSON value '{"@context":["https://www.w3.org/ns/activitystreams","http://trustbloc.github.io/did-method-orb/contexts/anchor/v1"],"type":"InviteWitness","actor":"${domain2IRI}","to":"${domain1IRI}","object":"${domain1IRI}"}'
    ...
    When an HTTP POST is sent to "http://orb.domain2.com/services/orb/outbox" with content from file "./fixtures/testdata/offer_activity.json"
    ...
    When an HTTP GET is sent to "http://orb.domain1.com/services/orb/liked?page=true"
    Then the JSON path "type" of the response equals "OrderedCollectionPage"
    ...
    When an HTTP POST is sent to "http://orb.domain2.com/services/orb/outbox" with content "${undoInviteWitnessActivity}" of type "application/json"
  ...
  Scenario: Tests HTTP signature verification
    ...
    When an HTTP POST is sent to "http://orb.domain2.com/services/orb/outbox" with content "${followActivity}" of type "application/json" and the returned status code is 401

    # Invalid signature on POST
    When an HTTP POST is sent to "http://orb.domain2.com/services/orb/outbox" with content "${followActivity}" of type "application/json" signed with KMS key from "domain1" and the returned status code is 401

    # Valid signature on POST
    When an HTTP POST is sent to "http://orb.domain2.com/services/orb/outbox" with content "${followActivity}" of type "application/json" signed with KMS key from "domain2"
    Then the value of the JSON string response is saved to variable "followID"

    Then we wait 2 seconds

    # No signature on GET
    When an HTTP GET is sent to "http://orb.domain1.com/services/orb/inbox" and the returned status code is 401
    When an HTTP GET is sent to "http://orb.domain1.com/services/orb/followers" and the returned status code is 401

    # Valid signature on GET with actor as a follower - should be allowed
    When an HTTP GET is sent to "http://orb.domain1.com/services/orb/inbox" signed with KMS key from "domain2"
    Then the JSON path "type" of the response equals "OrderedCollection"

    # Valid signature on GET with actor as non-follower/non-witness - should be denied
    When an HTTP GET is sent to "http://orb.domain1.com/services/orb/inbox" signed with KMS key from "domain3" and the returned status code is 401

    And variable "undoFollowActivity" is assigned the JSON value '{"@context":"https://www.w3.org/ns/activitystreams","type":"Undo","actor":"${domain2IRI}","to":"${domain1IRI}","object":"${followID}"}'
    Then an HTTP POST is sent to "http://orb.domain2.com/services/orb/outbox" with content "${undoFollowActivity}" of type "application/json" signed with KMS key from "domain2"
  ...
  Scenario: Tests authorization tokens
    ...
    Given variable "followActivity" is assigned the JSON value '{"@context":"https://www.w3.org/ns/activitystreams","type":"Follow","actor":"${domain2IRI}","to":"${domain1IRI}","object":"${domain1IRI}"}'
    When an HTTP POST is sent to "http://orb.domain2.com/services/orb/outbox" with content "${followActivity}" of type "application/json" and the returned status code is 401
    When an HTTP POST is sent to "http://orb.domain3.com/services/orb/inbox" with content "${followActivity}" of type "application/json" and the returned status code is 401
    When an HTTP POST is sent to "http://orb.domain3.com/services/orb/outbox" with content "${followActivity}" of type "application/json" and the returned status code is 401
    ...
    And an HTTP GET is sent to "http://orb.domain1.com/services/orb/inbox" and the returned status code is 401

    # Domain3 doesn't require authorization for reads
    When an HTTP GET is sent to "http://orb.domain3.com/services/orb/inbox"
    Then the JSON path "type" of the response equals "OrderedCollection"
    When an HTTP GET is sent to "http://orb.domain3.com/services/orb/outbox"
    Then the JSON path "type" of the response equals "OrderedCollection"
    When an HTTP GET is sent to "http://orb.domain3.com/services/orb/followers"
    Then the JSON path "type" of the response equals "Collection"
    When an HTTP GET is sent to "http://orb.domain3.com/services/orb/witnesses"
    Then the JSON path "type" of the response equals "Collection"
    When an HTTP GET is sent to "http://orb.domain3.com/services/orb/liked"
    Then the JSON path "type" of the response equals "OrderedCollection"
