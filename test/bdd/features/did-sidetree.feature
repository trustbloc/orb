...
""" TODO: issue-266 Create more dbs/servers for did-discovery test and bring discover did test back
    ...
    Scenario: discover did
      ...
      When client sends request to "https://orb.domain2.com/sidetree/v1/identifiers" to resolve DID document with canonical id
...
"""
    ...
    Scenario: domain2 server follows domain1 server (anchor writer)
      ...
      When client sends request to "https://orb2.domain2.com/sidetree/v1/identifiers" to resolve DID document
      Then check success response contains "#did"
