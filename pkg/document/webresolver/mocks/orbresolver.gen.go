...
func (fake *OrbResolver) ResolveDocument(arg1 string) (*document.ResolutionResult, error) {
...
func (fake *OrbResolver) ResolveDocumentCalls(stub func(string) (*document.ResolutionResult, error)) {
	fake.resolveDocumentMutex.Lock()
	defer fake.resolveDocumentMutex.Unlock()
	fake.ResolveDocumentStub = stub
}

func (fake *OrbResolver) ResolveDocumentArgsForCall(i int) string {
	fake.resolveDocumentMutex.RLock()
	defer fake.resolveDocumentMutex.RUnlock()
