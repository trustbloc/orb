...
type CompressionProvider struct {
	CompressStub        func([]byte) (string, []byte, error)
...
func (fake *CompressionProvider) Compress(arg1 []byte) (string, []byte, error) {
	var arg1Copy []byte
	if arg1 != nil {
	...
	fake.recordInvocation("Compress", []interface{}{arg1Copy})
	fake.compressMutex.Unlock()
	if fake.CompressStub != nil {
		return fake.CompressStub(arg1)
	}
	if specificReturn {
...
func (fake *CompressionProvider) CompressCalls(stub func([]byte) (string, []byte, error)) {
	fake.compressMutex.Lock()
	defer fake.compressMutex.Unlock()
	fake.CompressStub = stub
}

func (fake *CompressionProvider) CompressArgsForCall(i int) []byte {
	fake.compressMutex.RLock()
	defer fake.compressMutex.RUnlock()
...
func (fake *CompressionProvider) CompressReturns(result1 string, result2 []byte, result3 error) {
	fake.compressMutex.Lock()
	defer fake.compressMutex.Unlock()
...
func (fake *CompressionProvider) CompressReturnsOnCall(i int, result1 string, result2 []byte, result3 error) {
	fake.compressMutex.Lock()
	defer fake.compressMutex.Unlock()
	fake.CompressStub = nil
