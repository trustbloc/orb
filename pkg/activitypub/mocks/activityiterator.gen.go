...
func (fake *ActivityIterator) Close() error {
...
func (fake *ActivityIterator) CloseCallCount() int {
	fake.closeMutex.RLock()
	defer fake.closeMutex.RUnlock()
	return len(fake.closeArgsForCall)
}

func (fake *ActivityIterator) CloseCalls(stub func() error) {
	fake.closeMutex.Lock()
	defer fake.closeMutex.Unlock()
	fake.CloseStub = stub
}

func (fake *ActivityIterator) CloseReturns(result1 error) {
	fake.closeMutex.Lock()
	defer fake.closeMutex.Unlock()
	fake.CloseStub = nil
...
func (fake *ActivityIterator) CloseReturnsOnCall(i int, result1 error) {
	fake.closeMutex.Lock()
	defer fake.closeMutex.Unlock()
	fake.CloseStub = nil
...
func (fake *ActivityIterator) NextCalls(stub func() (*vocab.ActivityType, error)) {
	fake.nextMutex.Lock()
...
func (fake *ActivityIterator) TotalItems() (int, error) {
...
func (fake *ActivityIterator) TotalItemsCalls(stub func() (int, error)) {
	fake.totalItemsMutex.Lock()
	defer fake.totalItemsMutex.Unlock()
	fake.TotalItemsStub = stub
}

func (fake *ActivityIterator) TotalItemsReturns(result1 int, result2 error) {
	fake.totalItemsMutex.Lock()
	defer fake.totalItemsMutex.Unlock()
...
func (fake *ActivityIterator) TotalItemsReturnsOnCall(i int, result1 int, result2 error) {
	fake.totalItemsMutex.Lock()
	defer fake.totalItemsMutex.Unlock()
	fake.TotalItemsStub = nil
