...
type nodeInfo20Req struct{} //nolint: unused

// nodeInfo20Resp model
//
// swagger:response nodeInfo20Resp
type nodeInfo20Resp struct { //nolint: unused
	// in: body
	Body *NodeInfo
}
...
type nodeInfo21Req struct{} //nolint: unused

// nodeInfo21Resp model
//
// swagger:response nodeInfo21Resp
type nodeInfo21Resp struct { //nolint: unused
	// in: body
	Body *NodeInfo
}
